...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #992424">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="#" id="sidebarToggle">
      <button class="btn btn-outline-light" style="margin-right: 20px; border-width :2px;">
      ...
      <img src="{{ asset('img/Logo (3295x1171).png') }}" style="width: 150px; height: auto;">
    </a>
      ...
      <ul class="navbar-nav ms-auto">
        @guest
          <li class="nav-item active">
            <b style="color: aliceblue">AKTI | Evaluasi</b>
          </li>
        @else
          <li class="nav-item">
...
<div>
  ...
  <div id="sidebar" class="sidebar">
      ...
      <div class="sidebar-logo">
          <a href="#"><img src="{{ asset('img/Logo (3295x1171).png') }}" onclick='sidebar.classList.remove("active");overlay.classList.remove("active");' alt="Logo"></a>
      </div>
      <hr>
       <ul>
          @guest
              <li><a href="{{ route('login') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002-.014.002zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4"/>
              </svg> Mahasiswa</a></li>
              
              <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mortarboard" viewBox="0 0 16 16">
                <path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917zM8 8.46 1.758 5.965 8 3.052l6.242 2.913z"/>
                <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466zm-.068 1.873.22-.748 3.496 1.311a.5.5 0 0 0 .352 0l3.496-1.311.22.748L8 12.46z"/>
              </svg> Alumni</a></li>
          @else

          <li><a href="{{ route('admin.home') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
            <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
          </svg>&nbsp;Home</a></li>

              @if(auth()->user()->group_id == 99)
                  <li><a href="{{ route('dashboard.edom') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer2" viewBox="0 0 16 16">
                  ...
                  <li><a href="{{ route('admin.modify') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
      ...
      <!-- Logout Button -->
      @auth
      <a href="{{ route('logout') }}" class="logout"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0z"/>
                        <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/>
                    </svg>&nbsp; Keluar</a>
      @endauth
  </div>
    <button id="closeSidebarButton" class="close-sidebar-button" onclick='sidebar.classList.remove("active");overlay.classList.remove("active");'>&lt;</button>
</div>
<!-- Modal -->
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="bugReportModalLabel">Laporkan Bug</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
              <p>Kalau terdapat error atau bug, silahkan hubungi lewat email atau nomor whatsapp berikut:</p>
              {{-- ganti dengan nomor dan email developer, untuk skrg masih pakai punya gerald --}}
              ...
              </svg> Email: <a href="mailto:testg2984@gmail.com">testg2984@gmail.com</a></p>
              ...
              </svg> Telepon/WA: <a href="https://wa.me/6282311921842">+62 823-1192-1842</a></p>
          </div>
          <div class="modal-footer">
            <p>Kalau ada foto/video keterangannya, akan sangat membantu. </p><p>~Terima kasih</p>
        </div>
      </div>
  </div>
</div>
