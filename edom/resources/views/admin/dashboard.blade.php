    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 d-none d-md-block page-sidebar sticky-top">
                ...
                <div class="list-group">
                    <a href="#monthlyEvaluations" class="list-group-item">Evaluasi Per 4 Minggu (Per Bulan)</a>
                    <a href="#weeklyEvaluations" class="list-group-item">Evaluasi Per Minggu</a>
                    <a href="#evaluationCalendar" class="list-group-item">Kalender Pengisian Evaluasi</a>
                </div>
        </div>
