    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid #000;">
        ...
        <tbody>
            ...
            @foreach ($summary as $section => $data)
                ...
                <tr style=" border: 1px solid #000;">
                    ...
                    <td style="text-align: center; border: 1px solid #000;">
                        <strong>
                            {{ 
                                $sectionTotals[$section]['total'] > 0 
                                ? number_format((($sectionTotals[$section][1] * 1) + ($sectionTotals[$section][2] * 2) + ($sectionTotals[$section][3] * 3) + ($sectionTotals[$section][4] * 4)) / $sectionTotals[$section]['total'], 2)
                                : '-' 
                            }}
                        </strong>
                    </td>
            ...
            <tr style="background-color: #ffc404; border: 1px solid #000;">
                ...
                <td style="text-align: center; border: 1px solid #000;">
                    <strong>{{  $totalResponses > 0 
                                ? number_format($totalScoreSum / $totalResponses, 2): "-" }}</strong>
                </td>
            </tr>
            <!-- Percentage Row -->
            <tr style="background-color: #ffc404; color: #333; border: 1px solid #000;">
...
<div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
    ...
    <a class="btn btn-primary" href="{{ route('evaluation.summaryTOPKR.pdf', ['matkulId' => $matkul->id, 'lecturerId' => $lecturer->id]) }}">Download PDF</a>
</div>
